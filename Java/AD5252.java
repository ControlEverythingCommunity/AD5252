...
public class AD5252
{
	public static void main(String args[]) throws Exception
	{
		...
		// Get I2C device, AD5259 I2C address is 0x2C(44)
		...
		// Convert the data
		double res_1 = ((data[0] & 0xFF) / 256.0) * 10.0;
		double res_2 = ((data[1] & 0xFF) / 256.0) * 10.0;

		// Output data to screen
		System.out.printf("Resistance Channel-0 : %.2f K %n", res_1);
		System.out.printf("Resistance Channel-1 : %.2f K %n", res_2);
	}
}
